...
public class FormCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 480, 270));
    ...
    try{
       ...
       ps=config.koneksidb.getKoneksi().prepareStatement(sql);
        ps.setString(1,Tidcustomer.getText());
        ps.setString(2,Tnama.getText());
        ps.setString(3,Talamat.getText());
        ps.executeUpdate();
    ...
    {
        JOptionPane.showMessageDialog(this,"Kode Customer ini sudah ada, silahkan masukkan Kode Customer yang baru" );
    }
